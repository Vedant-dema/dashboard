...
def test_render_database_url_is_normalized_to_psycopg(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_production_startup_report_flags_localhost_only_cors(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_development_startup_report_allows_local_defaults(monkeypatch: pytest.MonkeyPatch) -> None:
